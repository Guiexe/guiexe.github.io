...
<head>
    ...
    <meta name="description" content="Catch all possibilities.">
    <meta name="author" content="Zypher F. Vheigns">

        <title>Shared Medical Journal</title>
...
<body>
    ...
    <header id="header-nav" role="banner">
        <div id="navbar" class="navbar navbar-default">
            <div class="navbar-header">
                <a class="navbar-brand" href="#"><div class="site-logo"></div>Medical Journal</a>
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav flot-nav">
                    ...
                    <li><a href="#services-section">Item</a></li>
                    <li><a href="#portfolio-section">Item</a></li>
                    <li><a href="#pricing-section">Item</a></li>
    ...
    <section id="slide-head" class="carousel parallax-section-1">
        <div class="carousel-inner" style="visibility:hidden">
            <div class="item active">
                <div class="container">
                    <div class="carousel-content">
                        <h1>Thirdy Kero</h1>
                        <p class="lead text-color-white text-light">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec enim sapien.<br>
                            <a href="#" class="btn btn-success btn-lg margin-top-20">Learn More</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="about-section">
        <div class="wrap-pad">
            <div class="row">
                ...
                <!-- ./ Heading div-->
                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 margin-top-100" style="visibility:hidden;">
        ...
        <div class="wrap-pad">
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1 col-sm-12" data-scrollreveal="enter right and move 100px, wait 0.6s">
                    <ul class="portfolio-items col-3" style="visibility:;">
                        <li class="portfolio-item ">
                            <div class="item-main">
                                <div class="portfolio-image">
                                    <img src="assets/img/portfolio/thumb/t1.png" alt="">
                                    <div class="overlay">
                                        <a class="preview btn btn-primary" title="Image Title Here" href="assets/img/portfolio/thumb/t1.png"><i class=" fa fa-eye"></i></a>
                                    </div>
                                </div>
    ...
    <footer id="footer">
        <div class="row">
            <div class="col-md-12  col-sm-12">
                &copy; 2015 www.qstudio.com  |  All Rights Reserved
    ...
    <!-- CUSTOM SCRIPT-->
    <script src="assets/scripts/fc-custom.js"></script>
    <!--PROTOTYP JS -->
    <script type='text/javascript' src='assets/js/prototype-c161.js'></script>
    <!--PARALLAX EFFECT -->
    <script src="assets/scripts/parallax-plugin.js"></script>
    ...
    <script type="text/javascript">
        (function($){
            $(document).ready(function(){
                ...
                var $window = $(window).on('resize', function(){
                   ...
                   $("section#slide-head").height(height);
                }).trigger('resize'); 
        ...
        <!-- <form id='formOne' onsubmit='return fromOne_onSubmit()'>
            Enter your name:    
            <input id='txtName' type='text' value='Francis Carl Protoyping'/>
        ...
        {
            new Ajax.Request('AjaxRequestSample.php', {
                method    : 'get',
